...
function FilterBarPanel({name, activePanel, filters, selected, onSelect, onClose}) {
    const ref = useRef();
    ...
    const handleClick = (value, isSelected) => onSelect(name, value, isSelected ? 'unselect' : 'select');
