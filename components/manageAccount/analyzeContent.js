...
export default function AnalyzeContent() {
  ...
  return (
    <div className={styles.container}>
      <div className={styles.title}>آنالیز محتوا</div>
          ...
          return (
            <div key={index} className={styles.contentBox}>
                ...
                <div className={styles.image}>
                  <div className={styles.img}>
                    <Image
                      width={60}
                      height={60}
                      loader={() => content.coverImage?.url}
                      src={content.coverImage?.url || NoImage}
                      alt=""
                    />
                  </div>
              ...
              <div className={styles.info}>
                <Text color="primary">{renderTime(content)}</Text>
                <Text color="primary">{content.visitCount || 0} بازدید</Text>
                <Text color="primary">{`${content.likesCount} پسند`}</Text>
                <Text color="primary">{`${content.commentsCount} نظر`}</Text>
                <Text color="primary" className={styles.income}>
      ...
      <Button classes={styles.button}>موارد بیشتر</Button>
    </div>
  );
}
