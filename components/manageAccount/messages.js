    ...
    <>
      ...
      <div className={styles.tabs}>
        <div
          className={`${styles.tab} ${
            activeIndex === 1 ? styles.active : styles.normal
          }`}
          onClick={() => changeTab(1)}
        >
        ...
        <div
          className={`${styles.tab} ${
            activeIndex === 2 ? styles.active : styles.normal
          }`}
          onClick={() => changeTab(2)}
        >
        ...
        <div
          className={`${styles.tab} ${
            activeIndex === 3 ? styles.active : styles.normal
          }`}
          onClick={() => changeTab(3)}
        >
      ...
      >
        ...
        >
          ...
          <input
            {...newMessageRegister("title", {
              required: "پر کردن این فیلد الزامی است",
            })}
            className={styles.titleInput}
            placeholder="عنوان"
            name="title"
            error={messageErrors.title}
          />
          <textarea
          ...
          <span className={styles.error}>
            {messageErrors.message !== undefined
