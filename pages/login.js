                                ...
                                <Card>
                                    <div className={styles.inputsContainer}>
                                        ...
                                        <div className={styles.hintContainer}>
                                            با ورود یا ثبت نام در دیجی نشر، شما قوانین و شرایط استفاده از سرویس دیجی نشر را می پذیرید.
                                        </div>
                                    </div>
                                </Card>
                            </div>
                                    ...
                                    <div className={styles.inputsContainer}>
                                        ...
                                        <form onSubmit={handleInfoSubmit(onInfoSubmit)}>
                                            ...
                                            <div className={styles.radioContainer}>
                                                ...
                                                <label htmlFor='publisherTrue' className={styles.radioInputLabel}>بله</label>
