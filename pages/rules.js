...
function Rules() {
    return (
        <div className={`container ${styles.container}`}>
            <Text component='h1' color='primary' weight='bold' size='l' className={styles.title}>قوانین و مقررات</Text>

            <Text component='h3' size='l' weight='bold' style={{margin: 0}}>عنوان</Text>
